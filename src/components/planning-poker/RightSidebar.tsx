import { MessageSquare, Hand, Timer, Send, ChevronLeft } from 'lucide-react'
...
export default function RightSidebar({
  ...
  return (
    <Drawer.Root open={isOpen} modal={false} onOpenChange={setIsOpen}>
      <div
            ...
            {activeTab === 'chat' && (
              <>
                ...
                <form
                  ...
                  className="flex shrink-0 gap-1.5 px-3 pb-4 pt-2"
                >
                  <input
                    type="text"
                    value={input}
              ...
              <div className="flex flex-1 flex-col gap-3 overflow-y-auto px-3 py-3">
                ...
                {isModerator && (
                  <div>
                    ...
                    >
                      Raised hands{' '}
                      {raisedPlayers.length > 0 && `(${raisedPlayers.length})`}
                    </p>
                    {raisedPlayers.length === 0 ? (
                      <p
                        className="text-xs"
