      ...
      <div
        className={cn(
          ...
          vote
            ...
            : 'border-[var(--border)] bg-[var(--surface)] text-[var(--ink-muted)] text-xs',
        )}
      ...
      <ul className="flex flex-col gap-1.5">
        {players.map((player) => (
          ...
          >
            ...
            <div className="flex min-w-0 flex-1 items-center gap-1.5">
              <span className="truncate text-sm font-medium text-[var(--ink)]">
                ...
                {player.id === currentPlayerId && (
                  <span className="ml-1 text-xs text-[var(--ink-muted)]">(you)</span>
                )}
              </span>
              <span
                className={cn(
            ...
            {/* Card slot */}
            <CardSlot phase={phase} voted={player.voted} vote={player.vote} />
          </li>
        ))}
