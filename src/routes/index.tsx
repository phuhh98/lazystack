...
function App() {
  return (
    <main className="page-wrap px-4 pt-14 pb-8">
      <IslandShell as="section" className="rise-in relative overflow-hidden rounded-4xl px-6 py-10 sm:px-10 sm:py-14">
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-wrap gap-3">
            <a
              className="rounded-full border border-[rgba(50,143,151,0.3)] bg-[rgba(79,184,178,0.14)] px-5 py-2.5 text-sm font-semibold text-(--primary-deep) no-underline transition hover:-translate-y-0.5 hover:bg-[rgba(79,184,178,0.24)]"
              href="/about"
            >
              About This Starter
            </a>
            <a
              className="rounded-full border border-[rgba(23,58,64,0.2)] bg-white/50 px-5 py-2.5 text-sm font-semibold text-(--ink) no-underline transition hover:-translate-y-0.5 hover:border-[rgba(23,58,64,0.35)]"
      ...
      <IslandShell as="section" className="mt-8 rounded-2xl p-6">
        <p className="island-kicker mb-2">Quick Start</p>
        <ul className="m-0 list-disc space-y-2 pl-5 text-sm text-(--ink-muted)">
          <li>
