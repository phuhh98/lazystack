...
export default function SessionDashboard({
  ...
  const numeric = completed
    .map((s) => parseInt(s.estimatedVote!, 10))
    .filter((n) => !isNaN(n))
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-wrap gap-4">
        <div
          className="island-shell rounded-2xl px-5 py-3 text-center"
            ...
            <tbody>
              {storyList.map((story, idx) => (
                <tr
                  ...
                  style={{
                    borderBottom:
                      idx < storyList.length - 1 ? '1px solid var(--border)' : 'none',
